...
func NewRoute(db *sql.DB, chi chi.Router, tokenGen auth.TokenGenerator, rbac *rbac.PermissionCache) *Route {
	AuthRepo := repositories.NewAuthRepository(db)
	AuthService := AuthService.NewService(db, AuthRepo, tokenGen, rbac)
