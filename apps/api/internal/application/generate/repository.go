...
func (r *RepositoryImpl) GetModelConfig(ctx context.Context, modelID, serviceType string) (*generate.ModelConfig, error) {
...
func (r *RepositoryImpl) SaveHistory(ctx context.Context, history *generate.GenerationHistory) error {
	query := `
