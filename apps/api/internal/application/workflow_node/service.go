// internal/application/workflow/workflow_node_service.go
package workflow
...
func NewWorkflowNodeService(repo workflow_node.WorkflowNodeRepository) *WorkflowNodeService {
...
func (s *WorkflowNodeService) Update(ctx context.Context, id string, updates map[string]interface{}) error {
	...
	// Validate step_order if provided
